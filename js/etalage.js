...
/* Edit by: David on 22/04/17
   ------------------------------	
	var $thumb_images = $thumbs.find('.etalage_thumb_image').css({ maxWidth:o.thumb_image_width})	

	$magnifier_img.css({ margin:0, padding:0, maxWidth:o.thumb_image_width, height:o.thumb_image_height });
...
// NEW ELEMENTS & CACHE
                ...
                $thumbs.first().show().addClass('etalage_thumb_active').css({/*opacity: 0.1 */});
				...
				//alert (o.thumb_image_height);
                var $thumb_images = $thumbs.find('.etalage_thumb_image').css({ maxWidth:o.thumb_image_width}).show();
                ...
                var $zoom_img_area = $zoom.children('div'),
                    $zoom_preview;
                if(preview){
                    $zoom_preview = $('<img class="etalage_zoom_preview" />').css({ width:o.source_image_width, height:o.source_image_height, opacity:0.9 }).prependTo($zoom_img_area).show();
                }
